...
class TestLibsRunBash:
    ...
    def test_run_bash():
        ...
        expected_connection = common_pb2.RemoteConnection()
        expected_connection.environment.name = 'RemoteConnectionEnv'
        expected_connection.environment.reference = 'remoteConnectionReference'
        ...
        def mock_run_bash(actual_run_bash_request):
            ...
            assert (actual_environment.name ==
                    expected_connection.environment.name)
            assert (actual_environment.reference ==
                    expected_connection.environment.reference)
    ...
    def test_run_bash_with_actionable_error():
        ...
        with mock.patch('dlpx.virtualization._engine.libs.run_bash',
            ...
            with pytest.raises(LibraryError) as err_info:
                libs.run_bash(connection, 'command')
    ...
    def test_run_bash_bad_remote_connection():
        ...
        assert err_info.value.message == (
            ...
            " class 'dlpx.virtualization.common_pb2.RemoteConnection'.")

    @staticmethod
    def test_run_bash_bad_command():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
    ...
    @staticmethod
    def test_run_bash_variables_not_dict():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
        command = 'command'
    ...
    @staticmethod
    def test_run_bash_bad_variables():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
        command = 'command'
    ...
    @staticmethod
    def test_run_bash_bad_use_login_shell():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
        command = 'command'
...
class TestLibsRunSync:
    ...
    @staticmethod
    def test_run_sync_bad_source_directory():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
    ...
    @staticmethod
    def test_run_sync_bad_rsync_user():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
        source_directory = 'sourceDirectory'
    ...
    @staticmethod
    def test_run_sync_exclude_paths_not_list():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
        source_directory = 'sourceDirectory'
    ...
    @staticmethod
    def test_run_sync_bad_exclude_paths():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
        source_directory = 'sourceDirectory'
    ...
    @staticmethod
    def test_run_sync_bad_sym_links_to_follow():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
        source_directory = 'sourceDirectory'
...
class TestLibsRunPowershell:
    ...
    def test_run_powershell_with_actionable_error():
        ...
        with mock.patch('dlpx.virtualization._engine.libs.run_powershell',
                        return_value=response, create=True):
            with pytest.raises(LibraryError) as err_info:
                libs.run_powershell(connection, 'command')
    ...
    @staticmethod
    def test_run_powershell_bad_command():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
        # Set the command be an int instead of a string.
    ...
    @staticmethod
    def test_run_powershell_variables_not_dict():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
        command = 'command'
...
class TestLibsRunExpect:
    ...
    def test_run_expect_with_actionable_error():
        ...
        with mock.patch('dlpx.virtualization._engine.libs.run_expect',
                        return_value=response, create=True):
            with pytest.raises(LibraryError) as err_info:
                libs.run_expect(connection, 'command')

        assert err_info.value._id == expected_id
        assert err_info.value.message == expected_message

    @staticmethod
    def test_run_expect_with_nonactionable_error():
    ...
    @staticmethod
    def test_run_expect_bad_command():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
        # Set the command be an int instead of a string.
    ...
    @staticmethod
    def test_run_expect_variables_not_dict():
        connection = common_pb2.RemoteConnection()
        connection.environment.name = 'RemoteConnectionEnv'
        connection.environment.reference = 'remoteConnectionReference'
        command = 'command'
