...
The CLI is installed with the SDK. To install the SDK, refer to the [Getting Started](/Getting_Started.md) section. To set up a config file, refer to the [CLI Configuration File](../Best_Practices/CLI_Configuration_File.md) section.
